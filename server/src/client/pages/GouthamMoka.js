...
const baseurl = "http://10.2.11:4069/api"

class GouthamMoka extends Component {
                            ...
                            <div className="col-lg-4 mx-auto">
                                <div className="auth-form-light text-left p-5">
                                    <div className="login-header">
                                        ...
                                        <hr />
                                        <h4 className="font-weight-light">Admin Login</h4>
                                    ...
                                    <form className="pt-5" autoComplete="off" >
                                        ...
                                        <div className="mt-5">
                                            <button className="btn btn-block btn-primary btn-lg font-weight-medium" type="submit" onClick={this.login} >Login</button>
                                        </div>
                                        <div className="row">
                            ...
                            <i className="input-helper" /></label>
                                            ...
                                            <div className="col-md-6 col-sm-6">
                                                <div className="mt-3 text-right">
                                                    <a className="auth-link text-gray" >Forgot password?</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
...
export default {
    component: connect(mapStateToProps, { fetchlogin })(GouthamMoka),
    loadData: ({ dispatch }) => dispatch(fetchlogin())
};
